...
public class PharmacistPrescCheckService {
     ...
     */
    public CheckMessage checkPharmacistPresc(int tag, String patientId,String presDate, String data) {
        String url = checkServerUrl + "?tag=" + tag + "&patientId=" + patientId + "&presDate=" + presDate;
